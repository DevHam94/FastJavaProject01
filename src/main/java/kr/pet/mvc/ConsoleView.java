...
public class ConsoleView {
    ...
    public Customer getCustomerInfo(){
        ...
        String phoneNubmer = scanner.nextLine();
        ...
        return new Customer(phoneNubmer, ownerName, petName, address, species, birthYear);
    }
    // 진료기록을 입력 받는 화면
    ...
    public void printMedicalRecordInfo(Customer customer){
        ...
        System.out.println("[" + customer.getPhoneNumber() + "]의 진료기록");
